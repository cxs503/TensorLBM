...
# from the interface.  Its exchange distance is intentionally not doubled:
# this pilot halves the physical sampling height and tests the predicted y+
# reduction independently of any empirical drag correction.
