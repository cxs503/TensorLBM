...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run a 2D rotating cylinder (Magnus effect) LBM demonstration."
    )
    parser.add_argument("--nx", type=int, default=320, help="Grid width")
    parser.add_argument("--ny", type=int, default=100, help="Grid height")
    parser.add_argument("--u-in", dest="u_in", type=float, default=0.08, help="Inlet velocity")
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Non-dimensional spin α = ω R / u∞ (positive ⇒ CCW)",
    )
    parser.add_argument("--n-steps", dest="n_steps", type=int, default=1200)
    parser.add_argument("--output-interval", type=int, default=200)
