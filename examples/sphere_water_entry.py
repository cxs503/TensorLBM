"""Command-line example: sphere/cylinder water-entry benchmark.

Usage
-----
    PYTHONPATH=src python examples/sphere_water_entry.py [options]
...
from tensorlbm import SphereWaterEntryConfig, run_sphere_water_entry
