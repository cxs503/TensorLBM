...
REF = {
    ...
    "sphere_cd_re50": 1.57,
    "sphere_cd_re100": 1.09,
    "sphere_cd_re200": 0.77,
...
for re_val, cd_ref, label in [(50, 1.57, "Re=50"), (100, 1.09, "Re=100"), (200, 0.77, "Re=200")]:
    ...
    print(f"  Time: {t1:.0f}s")
    if result(f"Cd {label}", cd_mean, cd_ref):
        sphere_ok += 1
