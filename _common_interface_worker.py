...
BENCHMARKS = {
    "cyl_re40": {
        ...
        "avg_window": 1500,
        "Cd_ref": 1.50,
        "note": "D=48 gives Cd_tot=2.17 (45% high, grid too coarse). D=96 for better accuracy.",
    ...
    "cyl_re3900": {
        ...
        "avg_window": 1500,
        "Cd_ref": 0.98,
        "note": "D=48 tau=0.503 diverges. D=96 tau=0.506 diverges at step ~5600. D=192 tau=0.512 for stability.",
        "bc_config": {"far_field_faces": ["y-", "y+"], "periodic_faces": ["z-", "z+"]},
    },
    "sph_re300": {
        "shape": "sphere",
        ...
        "avg_window": 800,
        "Cd_ref": 0.44,
        "note": "120x80x80 gives Cd~1.0 (2.3x high, domain too narrow). 120x120x120 matches verified Re=100 worker.",
