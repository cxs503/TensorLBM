...
class TestFreeSurfaceDefaultUnchanged:
    ...
    def test_cs_zero_disables_sgs_regardless_of_model(self) -> None:
        ...
        out_wale = free_surface_step(f.clone(), fill, flags, solid, sgs_model="wale", **kwargs)
        out_vreman = free_surface_step(f.clone(), fill, flags, solid, sgs_model="vreman", **kwargs)
