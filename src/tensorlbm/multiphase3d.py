...
def collide_sc_two_component_3d(
    ...
    centre-of-mass velocity (Shan & Doolen 1995) — the 3D counterpart of
    :func:`tensorlbm.multiphase.collide_sc_two_component`:
    ...
    Args:
        ...
        u_eq:        Equilibrium-velocity convention: ``"self"`` (default,
                     ...
                     above no longer holds for that combination.
