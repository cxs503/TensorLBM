...
def test_retry_policy_succeeds_after_retry(job_manager, waiter):
    state = {"count": 0}
    ...
    cfg = {"orchestration": {"max_retries": 1}}
...
def test_orchestration_kpis(job_manager, waiter):
    job_id = _make_job(job_manager, name="kpi")
